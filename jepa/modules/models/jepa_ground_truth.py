...
class JEPA(BaseModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        embeddings_0, embeddings_1, edge_index = self._get_edge_embeddings(
            predicted_embedded_target_tracklets, embedded_target_tracklets, edge_index, edge_mask, x.shape[1]
        )
    ...
    def shared_evaluation(self, batch, batch_idx):
        ...
        if batch_idx == 0:
            self._plot_evaluation(
                x, pids, edge_index, edge_mask, y, distances, predicted_embedded_target_tracklets, embedded_target_tracklets
            )
